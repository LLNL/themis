...
from uqp.sensitivity import sensitivity
from uqp.surrogate_model.surrogate_model import SurrogateModel
from uqp.uq_component import plots
...
class TestPlots(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.surrogate_model = SurrogateModel('pce', self.input_names, self.output_names, self.ranges,
                                              num_degrees=3).fit(self.X,
                                                                 self.Y)
    ...
    def test_sensitivity_plot(self):
        ...
        fig.set_size_inches(10, 10)
        sensitivity.sensitivity_plot(ax, self.surrogate_model, num_plot_points=100, num_seed_points=5)
    ...
    def test_variance_network_plot(self):
        ...
        sensitivity.variance_network_plot(ax, self.surrogate_model, draw_node_labels=True, draw_contrib_labels=True)
    ...
    def test_rank_order_plot(self):
        fig, ax = plt.subplots(1, 1)
        sensitivity.rank_order_plot(ax, self.surrogate_model)
